...
public class GameManager : MonoBehaviour
{
    ...
    public string[] passLevelWithStarTexts = { "太完美了!!!", "难以置信!!!", "印象深刻!!", "太优秀了!!!", "简直完美!!!", "太漂亮了!!!" };
    [System.NonSerialized]
    public string[] passLevelTexts = { "做的好啊!!!", "做的不错!!!", "不错!!!", "可以!!!", "还不赖!!!" };
    [System.NonSerialized]
    public string[] gameOverTexts = { "继续努力!!!", "哎哟!!!", "犯错了!!!", "小心!!!", "不~!!!" };
